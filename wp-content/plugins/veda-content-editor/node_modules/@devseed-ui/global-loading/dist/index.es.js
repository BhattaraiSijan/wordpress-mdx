...
import { CollecticonArrowSpinCw } from '@devseed-ui/collecticons';
import styled, { createGlobalStyle } from 'styled-components';
import { themeVal, rgba, antialiased, glsp } from '@devseed-ui/theme-provider';
...
var BodyUnscrollable = createGlobalStyle(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  body {\n    overflow-y: hidden;\n  }\n"])));
var Spinner = /*#__PURE__*/styled.div.withConfig({
  displayName: "styles__Spinner",
  componentId: "sc-m6ses9-0"
})(["display:flex;animation:", " 1s linear infinite;transform:translateZ(0);"], rotateCW);
var GlobalLoadingWrapper = /*#__PURE__*/styled.div.withConfig({
  displayName: "styles__GlobalLoadingWrapper",
  componentId: "sc-m6ses9-1"
})(["position:fixed;top:0;left:0;height:100%;width:100%;z-index:9997;display:flex;justify-content:center;align-items:center;flex-flow:column;cursor:not-allowed;background:radial-gradient( farthest-side,", ",", " );&.overlay-loader-enter{transform:translate3d(0,0,0);transition:opacity 0.32s ease 0s,visibility 0.32s linear 0s;opacity:0;visibility:hidden;&.overlay-loader-enter-active{opacity:1;visibility:visible;}}&.overlay-loader-exit{transition:opacity 0.32s ease 0s,visibility 0.32s linear 0s;opacity:1;visibility:visible;&.overlay-loader-exit-active{opacity:0;visibility:hidden;}}"], themeVal('color.surface'), rgba(themeVal('color.surface'), 0.64));
var Message = /*#__PURE__*/styled.div.withConfig({
  displayName: "styles__Message",
  componentId: "sc-m6ses9-2"
})(["", " margin-top:", ";color:", ";text-align:center;"], antialiased(), glsp(), themeVal('color.base'));
...
function GlobalLoadingProvider(props) {
  ...
  return /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(CSSTransition$1, {
    in: revealed,
    unmountOnExit: true,
    appear: true,
  ...
  }, /*#__PURE__*/React.createElement(GlobalLoadingWrapper, {
    className: props.className,
    "data-testid": "global-loading"
  }, /*#__PURE__*/React.createElement(BodyUnscrollable, null), /*#__PURE__*/React.createElement(Spinner, null, /*#__PURE__*/React.createElement(CollecticonArrowSpinCw, {
    size: "xxlarge",
    title: "Rotating arrow to indicate a loading state",
    meaningful: true
  })), message && /*#__PURE__*/React.createElement(Message, null, message))), document.body);
}
...
export { GlobalLoading, GlobalLoadingProvider, hideGlobalLoading, showGlobalLoading, showGlobalLoadingMessage };
